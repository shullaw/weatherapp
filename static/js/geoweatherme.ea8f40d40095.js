...
function geoWeatherMe() {
    ...
    function success(position) {
      ...
      weatherLink.href = `https://api.openweathermap.org/data/2.5/onecall?lat=${latitude}&lon=${longitude}&appid={{API_KEY}}&units=${geoWeatherMe.unit}`;
      weatherLocation.textContent = '';
      locationLink.href = `https://api.openweathermap.org/data/2.5/weather?lat=${latitude}&lon=${longitude}&appid={{API_KEY}}&units=${geoWeatherMe.unit}`;
